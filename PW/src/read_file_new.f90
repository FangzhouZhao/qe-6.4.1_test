...
SUBROUTINE read_file()
  ...
  USE scf,                  ONLY : rho, rho_core, rhog_core, v  !FZ: test
  IMPLICIT NONE 
  ...
  IF (ionode) THEN                                          !FZ: test
    OPEN (unit = unit, file = 'test_read_file_new_v%of_r_1', &  !FZ: test
  ...
  !
  IF (ionode) THEN                                          !FZ: test
    OPEN (unit = unit, file = 'test_read_file_new_v%of_r_2', &  !FZ: test
      form = 'formatted', status = 'replace')               !FZ: test
    WRITE(unit, *)  "v%of_r = ", v%of_r    !FZ: test
    CLOSE (unit = unit, status = 'keep')      !FZ:  test
  ENDIF                                       !FZ:  test
  ...
  !
  IF (ionode) THEN                                          !FZ: test
    OPEN (unit = unit, file = 'test_read_file_new_v%of_r_3', &  !FZ: test
      form = 'formatted', status = 'replace')               !FZ: test
    WRITE(unit, *)  "v%of_r = ", v%of_r    !FZ: test
    CLOSE (unit = unit, status = 'keep')      !FZ:  test
  ENDIF                                       !FZ:  test
  ...
  !
  IF (ionode) THEN                                          !FZ: test
    OPEN (unit = unit, file = 'test_read_file_new_v%of_r_4', &  !FZ: test
      form = 'formatted', status = 'replace')               !FZ: test
    WRITE(unit, *)  "v%of_r = ", v%of_r    !FZ: test
    CLOSE (unit = unit, status = 'keep')      !FZ:  test
  ENDIF                                       !FZ:  test
  ...
  !
  IF (ionode) THEN                                          !FZ: test
    OPEN (unit = unit, file = 'test_read_file_new_v%of_r_5', &  !FZ: test
      form = 'formatted', status = 'replace')               !FZ: test
    WRITE(unit, *)  "v%of_r = ", v%of_r    !FZ: test
    CLOSE (unit = unit, status = 'keep')      !FZ:  test
  ENDIF                                       !FZ:  test
  ...
  CALL init_us_1()
  IF (ionode) THEN                                          !FZ: test
    OPEN (unit = unit, file = 'test_read_file_new_v%of_r_6', &  !FZ: test
      form = 'formatted', status = 'replace')               !FZ: test
    WRITE(unit, *)  "v%of_r = ", v%of_r    !FZ: test
    CLOSE (unit = unit, status = 'keep')      !FZ:  test
  ENDIF                                       !FZ:  test
  ...
  IF (ionode) THEN                                          !FZ: test
    OPEN (unit = unit, file = 'test_read_file_new_v%of_r_7', &  !FZ: test
      form = 'formatted', status = 'replace')               !FZ: test
    WRITE(unit, *)  "v%of_r = ", v%of_r    !FZ: test
    CLOSE (unit = unit, status = 'keep')      !FZ:  test
  ENDIF                                       !FZ:  test
  ...
  ENDIF 
  IF (ionode) THEN                                          !FZ: test
    OPEN (unit = unit, file = 'test_read_file_new_v%of_r_8', &  !FZ: test
      form = 'formatted', status = 'replace')               !FZ: test
    WRITE(unit, *)  "v%of_r = ", v%of_r    !FZ: test
    CLOSE (unit = unit, status = 'keep')      !FZ:  test
  ENDIF                                       !FZ:  test
  ...
  CALL newd()
  IF (ionode) THEN                                          !FZ: test
    OPEN (unit = unit, file = 'test_read_file_new_v%of_r_9', &  !FZ: test
      form = 'formatted', status = 'replace')               !FZ: test
    WRITE(unit, *)  "v%of_r = ", v%of_r    !FZ: test
    CLOSE (unit = unit, status = 'keep')      !FZ:  test
  ENDIF                                       !FZ:  test
...
SUBROUTINE read_xml_file ( wfc_is_collected )
  ...
  USE funct,        ONLY : dft_is_meta, get_meta            !FZ:  for megaGGA
  ...
  !
  !IF (ionode) THEN                                          !FZ: test
  !   OPEN (unit = unit, file = 'test_read_file_output3', &  !FZ: test
  !     form = 'formatted', status = 'replace')               !FZ: test
  !  WRITE(unit, *)  "et = ", et  !FZ: test
  !  CLOSE (unit = unit, status = 'keep')      !FZ:  test
  !ENDIF                                       !FZ:  test
  CALL init_vars_from_schema ( 'nowave', ierr, output_obj, parinfo_obj, geninfo_obj, input_obj )   !FZ: dft eigenvalues is read into et(:,:)
  !IF (ionode) THEN                                          !FZ: test
  !   OPEN (unit = unit, file = 'test_read_file_output2', &  !FZ: test
  !     form = 'formatted', status = 'replace')               !FZ: test
  !  WRITE(unit, *)  "et = ", et  !FZ: test
  !  CLOSE (unit = unit, status = 'keep')      !FZ:  test
  !ENDIF                                       !FZ:  test
  ...
  IF (ionode) THEN                                          !FZ: test
     OPEN (unit = unit, file = 'test_read_file_output_file', &  !FZ: test
       form = 'formatted', status = 'replace')               !FZ: test
    WRITE(unit, *)  "rho%kin_r = ", rho%kin_r    !FZ: test
    CLOSE (unit = unit, status = 'keep')      !FZ:  test
  ENDIF                                       !FZ:  test
  IF (ionode) THEN                                          !FZ: test
     OPEN (unit = unit, file = 'test_read_file_v%of_r_1', &  !FZ: test
       form = 'formatted', status = 'replace')               !FZ: test
    WRITE(unit, *)  "v%of_r = ", v%of_r    !FZ: test
    CLOSE (unit = unit, status = 'keep')      !FZ:  test
  ENDIF                                       !FZ:  test
  ...
  !
  CALL init_vloc()            !FZ: calculates vloc  vltot
  ...
  !
  IF (ionode) THEN                                          !FZ: test
     OPEN (unit = unit, file = 'test_read_file_v%of_r_2', &  !FZ: test
       form = 'formatted', status = 'replace')               !FZ: test
    WRITE(unit, *)  "v%of_r = ", v%of_r    !FZ: test
    CLOSE (unit = unit, status = 'keep')      !FZ:  test
  ENDIF                                       !FZ:  test
  ...
  !
  IF (ionode) THEN                                          !FZ: test
     OPEN (unit = unit, file = 'test_read_file_v%of_r_3', &  !FZ: test
       form = 'formatted', status = 'replace')               !FZ: test
    WRITE(unit, *)  "v%of_r = ", v%of_r    !FZ: test
    CLOSE (unit = unit, status = 'keep')      !FZ:  test
  ENDIF                                       !FZ:  test
  ...
  END IF
  IF (ionode) THEN                                          !FZ: test
     OPEN (unit = unit, file = 'test_read_file_v%of_r_4', &  !FZ: test
       form = 'formatted', status = 'replace')               !FZ: test
    WRITE(unit, *)  "v%of_r = ", v%of_r    !FZ: test
    CLOSE (unit = unit, status = 'keep')      !FZ:  test
  ENDIF                                       !FZ:  test
  ...
  IF (ionode) THEN                                          !FZ: test
     OPEN (unit = unit, file = 'test_read_file_v%of_r_5', &  !FZ: test
       form = 'formatted', status = 'replace')               !FZ: test
    WRITE(unit, *)  "v%of_r = ", v%of_r    !FZ: test
    CLOSE (unit = unit, status = 'keep')      !FZ:  test
  ENDIF                                       !FZ:  test
