...
SUBROUTINE electrons_scf ( printout, exxen )
  ...
  !
  !
  call create_scf_type ( rhoin )      !FZ:  create the structrue rhoin which contains info of charge density, kin En density ...
  !
  WRITE( stdout, 9002 )
  FLUSH( stdout )
  !
  ...
  DO idum = 1, niter
     ...
     !
     call scf_type_COPY( rho, rhoin )       !FZ:  rho is the input density! so rho is not initialized in this routine, it is initialized before
     !
     scf_step: DO
        !
